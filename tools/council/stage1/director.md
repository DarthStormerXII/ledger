...
- "KeeperHub re-routes through a private mempool. Four seconds. Five USDC paid. Bond returned. Reputation incremented on chain." — Five facts in one breath. Cut to: *"Private mempool. Four seconds. Paid."* The reputation +1 is on scree
